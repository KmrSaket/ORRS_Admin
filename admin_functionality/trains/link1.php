			    ...
			    <ul class="navbar-nav mr-auto">
			        	...
			        	<button class="dropbtn" id="dropdownMenu1" href="#" >Users</button>
								<div class="dropdown-content">
										<a href="../users/link1.php" style="color:black; text-decoration:none;">Link 1</a>
										<a href="../users/link2.php" style="color:black; text-decoration:none;">Link 2</a>
										<a href="../users/link3.php" style="color:black; text-decoration:none;">Link 3</a>
									</div>
								</div>
			      </li>
						...
						<li class="nav-item mr-5">
							<div class="dropdown">
			        	<button class="dropbtn" id="dropdownMenu2" href="#" style="background-color:#c1c1c1;">Trains</button>
								<div class="dropdown-content">
